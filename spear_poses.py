...
POSE = {
    ...
    'attack_spear': [
        ...
        {'offset_src_px': (6.0,  7.0),  'deg': 130.0},
        # 1: 어깨 쪽으로 올리는 중
        {'offset_src_px': (8.0,  6.5),  'deg': 150.0},
        # 2: 머리 위 근처
        {'offset_src_px': (10.5, 6.0),  'deg': 170.0},
        # 3: 뒤로 젖히며 최대 장전
        {'offset_src_px': (13.0, 6.0),  'deg': 195.0},
        # 4: 앞으로 던지기 시작
        {'offset_src_px': (15.5, 7.0),  'deg': 215.0},
        # 5: 완전히 앞으로 뻗어서 던진 포즈
        {'offset_src_px': (18.0, 8.5),  'deg': 235.0},
        # 6: 팔이 살짝 내려오며 후딜
        {'offset_src_px': (17.0, 10.0), 'deg': 250.0},
    ],
