...
JUMP_TEMPLATES: List[JumpTemplate] = [
    ...
    # [전략] 아주 멀리서(맵 중앙 쪽) 도움닫기
    # ==========================================================

    # [Left] 바닥 -> r3_L1
    # 기존: 0.18~0.24 -> 수정: 0.28 ~ 0.33 (완전히 플랫폼 밖 허공)
    JumpTemplate("floor_to_r3_L1_side", "floor", "r3_L1",
                 0.28, 0.33,
                 0.5, 0.9,
                 -1,
                 0.5),  # 거리 머니까 0.5초 풀 점프

    # [Right] 바닥 -> r3_R2
    # 기존: 0.76~0.82 -> 수정: 0.67 ~ 0.72 (완전히 플랫폼 밖 허공)
    ...
    JumpTemplate("r3_L2_to_r2_L_diag", "r3_L2", "r2_L",
                 0.80, 0.95, 0.6, 0.9, -1, 0.5),

    # r3_R1 -> r2_R
    JumpTemplate("r3_R1_to_r2_R_diag", "r3_R1", "r2_R",
                 0.05, 0.20, 0.1, 0.4, +1, 0.5),
