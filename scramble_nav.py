...
JUMP_TEMPLATES: List[JumpTemplate] = [
    ...
    JumpTemplate("r3_L2_to_mid_top", "r3_L2", "mid_top",
                 0.65, 0.95,   # 이륙: r3_L2 오른쪽 부분
                 0.0, 0.45,    # 착지: mid_top 왼쪽~중앙
                 +1, 0.5),

    # 오른쪽: r3_R1(1층 중앙 오른쪽) → mid_top
    #  - r3_R1의 왼쪽 30% 구간(0.05~0.35)에서 왼쪽 위로 점프
    #  - mid_top의 중앙~오른쪽(0.55~1.0)에 착지
    JumpTemplate("r3_R1_to_mid_top", "r3_R1", "mid_top",
                 0.05, 0.35,   # 이륙: r3_R1 왼쪽 부분
