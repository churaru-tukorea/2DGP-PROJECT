...
POSE = {
    ...
    'attack_fire': [{'offset_src_px': (21.45, 8.82), 'deg': 140.0},
                    {'offset_src_px': (18.27, 9.47), 'deg': 160.0},
                    {'offset_src_px': (18.5, 8.44), 'deg': 180.0},
                    {'offset_src_px': (20.5, 8.44), 'deg': 210.0},
                    {'offset_src_px': (23.93, 14.47), 'deg': 240.0},
                    {'offset_src_px': (17.67, 8.67), 'deg': 265.0},
                    {'offset_src_px': (17.67, 8.67), 'deg': 300.0}],
}