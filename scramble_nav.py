...
JUMP_TEMPLATES: List[JumpTemplate] = [
    ...
    JumpTemplate("r3_L2_to_r2_L_diag", "r3_L2", "r2_L",
                 0.05, 0.10,  # 이륙 위치 (왼쪽 끝)
                 0.6, 0.9,  # 착지 위치
                 -1,  # 왼쪽으로 이동
                 1.2),

    # [Right] r3_R1(중앙) -> r2_R(2층)
    JumpTemplate("r3_R1_to_r2_R_diag", "r3_R1", "r2_R",
                 0.90, 0.95,  # 이륙 위치 (오른쪽 끝)
                 0.1, 0.4,  # 착지 위치
                 +1,  # 오른쪽으로 이동
                 1.2),
    ...
    JumpTemplate("r3_R1_to_mid_top", "r3_R1", "mid_top",
                 0.35, 0.40,   # 이륙: r3_R1 중앙 쪽 (midtop에서 한 칸 떨어진 지점)
